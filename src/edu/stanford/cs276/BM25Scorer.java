...
*/
	...
	public static double k1 = 1.7;
	public static double pageRankLambda = 1.0;
	public static double pageRankLambdaPrime = 0.0;
	//////////////////////////////////////////
	...
	public double getNetScore(Map<String,Map<String, Double>> tfs, Query q, Map<String,Double> tfQuery,Document d) {
		...
		for (String term : q.queryWords)
		{
			...
			double idf_t = (null == idfs.get(term)) ? idfs.get(LoadHandler.specialTerm) : idfs.get(term);
